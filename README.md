...
- **Manual Execution of Main Function**: Provides a menu item in Google Sheets to manually trigger the core script functionality for processing subscriber emails.
